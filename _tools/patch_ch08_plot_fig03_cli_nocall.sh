...
trap 'code=$?;
  ...
  echo "[ASTUCE] Seul zz-scripts/chapter08/plot_fig03_mu_vs_z.py est touché, avec backup .bak_fix_cli_nocall.";
  read -rp "Appuie sur Entrée pour revenir au shell..." _' ERR

echo "== PATCH CH08 – CLI fig_03 sans appel main() =="
...
if idx == -1:
    sys.exit("[ERROR] Bloc '__main__' introuvable dans plot_fig03_mu_vs_z.py")
...
echo
echo "Terminé (patch_ch08_plot_fig03_cli_nocall)."
