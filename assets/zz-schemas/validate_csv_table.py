...
Validation d'un CSV contre un schéma "csv-table/v1" (voir assets/zz-schemas/*_table_schema.json).

Usage:
    python assets/zz-schemas/validate_csv_table.py <schema.json> <data.csv> [--max-errors N]
