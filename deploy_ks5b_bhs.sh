#!/bin/bash
# =================================================================
# Déploiement PTMG v3.3.0 - Laboratoire de Beauharnois (KS-5-B)
...
echo "--- [4/5] Clonage sécurisé de PTMG v3.3.0 ---"
...
git checkout v3.3.0 || echo "Note : Utilisation de la branche par défaut."
