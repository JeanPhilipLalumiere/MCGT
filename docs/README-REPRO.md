...
```bash
python scripts/chapter09/10_fig01_phase_overlay.py   --csv assets/zz-data/chapter09/09_phases_mcgt.csv   --meta assets/zz-data/chapter09/09_metrics_phase.json   --out assets/zz-figures/chapter09/09_fig_01_phase_overlay.png   --dpi 150
```
Sortie attendue : `assets/zz-figures/chapter09/09_fig_01_phase_overlay.png`.

## 2) Chapter 10 — générateur officiel (CSV)
```bash
python scripts/chapter10/generate_data_chapter10.py   --config assets/zz-data/chapter10/10_mc_config.json   --out-results assets/zz-data/chapter10/10_mc_results.csv
```
