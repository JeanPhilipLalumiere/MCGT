#!/usr/bin/env bash
# fasttrack_pr35_then_restore_strict_v2.sh — payload conforme (corrige 422)
set -euo pipefail
PR="${1:-35}"
...
echo "[PATCH] TEMP minimal…" | tee -a "$LOG"
