#!/bin/bash
# =================================================================
# Deployment Script for PTMG v4.0.0 on Kimsufi (Beauharnois/BHS)
...
echo "--- Clonage et Compilation de PTMG v4.0.0 ---"
if [ ! -d "MCGT" ]; then
    git clone --branch v4.0.0 https://github.com/JeanPhilipLalumiere/MCGT.git
fi
cd MCGT
...
echo "-------------------------------------------------------"
echo "Déploiement v4.0.0 terminé."
