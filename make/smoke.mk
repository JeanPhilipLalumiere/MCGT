...
smoke-ch09:
	...
	python scripts/09_dark_energy_cpl/plot_fig01_phase_overlay.py --csv assets/zz-data/chapter09/09_phases_mcgt.csv --meta assets/zz-data/chapter09/09_metrics_phase.json --out assets/zz-figures/chapter09/09_fig_01_phase_overlay.png --dpi 150 || true
