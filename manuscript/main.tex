...
\begin{figure}[htbp]
    ...
    Joint constraints highlight a correlation between matter density $\Omega_m$ and the equation of state $w_0$. The likelihood peak (marked by a cross) is located at the v3.1.0 best-fit coordinates ($\Omega_m = 0.243$, $w_0 = -0.69$).}
    \label{fig:contours}
\end{figure}
