...
\pagestyle{fancy}
\fancyhf{}
\rhead{\small MCGT v2.5.1 - The Great Reconciliation}
...
\date{Version 2.5.1 -- Release "The Great Reconciliation" -- D\'ecembre 2025}
...
\begin{equation}
    ...
    \label{eq:cpl}
\end{equation}
Les valeurs optimales audit\'ees (Best-Fit v2.5.1) sont :
\begin{equation*}
