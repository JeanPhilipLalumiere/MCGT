...
\hypersetup{
    ...
    filecolor=magenta,      
    urlcolor=cyan,
    pdftitle={MCGT v2.6.1: Modèle de la Courbure Gravitationnelle du Temps},
...
\pagestyle{fancy}
\fancyhf{}
\rhead{\small MCGT v2.6.1 -- "The Great Reconciliation"}
...
\date{Version 2.6.1 -- Février 2026}
...
\end{equation}
Les valeurs optimales auditées (\textbf{Best-Fit v2.6.1}) sont :
