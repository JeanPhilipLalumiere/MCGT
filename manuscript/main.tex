...
\hypersetup{
    ...
    filecolor=magenta,      
    urlcolor=cyan,
    pdftitle={MCGT: Modèle de la Courbure Gravitationnelle du Temps},
    pdfauthor={Jean-Philippe Lalumière},
}

% En-tête et pied de page
\pagestyle{fancy}
\fancyhf{}
\rhead{\small MCGT v2.5.4 -- "The Great Reconciliation"}
...
\author{\textbf{Jean-Philippe Lalumière} \\ Laboratoire de Cosmologie Théorique}
\date{Version 2.5.4 -- Décembre 2025}
...
La cosmologie de précision est entrée dans une ère de tensions statistiques irréductibles. Le modèle standard $\Lambda$CDM, bien que remarquablement efficace pour décrire le fond diffus cosmologique (CMB), échoue désormais à réconcilier l'Univers primordial avec l'Univers local.
...
\end{equation}
Les valeurs optimales auditées (\textbf{Best-Fit v2.5.0}) sont :
...
Validation de la règle standard sur les données eBOSS/SDSS. Le modèle sert de pivot géométrique robuste entre le CMB et les Supernovae.
