...
\pagestyle{fancy}
\fancyhf{}
\rhead{\small MCGT v2.5.0 - The Great Reconciliation}
...
\date{Version 2.5.0 -- Release "The Great Reconciliation" -- D\'ecembre 2025}
...
\begin{equation}
    ...
    \label{eq:cpl}
\end{equation}
Les valeurs optimales audit\'ees (Best-Fit v2.5.0) sont :
\begin{equation*}
