...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    default_data = racine / "assets/zz-data" / "07_bao_geometry" / "07_cs2_matrix.csv.gz"
    default_meta = racine / "assets/zz-data" / "07_bao_geometry" / "07_meta_perturbations.json"
    default_out = racine / "assets/zz-figures" / "07_bao_geometry" / "07_fig_01_hubble.png"

    p = argparse.ArgumentParser(
        description=(
            "Figure 01 – Carte de chaleur de c_s^2(k,a) (Chapter 7).\n"
