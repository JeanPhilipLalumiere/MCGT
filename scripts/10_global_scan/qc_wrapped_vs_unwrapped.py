...
def main(argv=None):
    ...
    parser.add_argument(
        "--best", required=True, help="json top-K (assets/zz-data/10_global_scan/10_mc_best.json)"
    )
    ...
    parser.add_argument(
        "--outdir", default="assets/zz-data/10_global_scan/qc_wrapped", help="répertoire de sortie"
    )
