...
def main(argv=None):
    ...
    parser.add_argument(
        "--best", required=True, help="json top-K (assets/zz-data/chapter10/10_mc_best.json)"
    )
    ...
    parser.add_argument(
        "--outdir", default="assets/zz-data/chapter10/qc_wrapped", help="répertoire de sortie"
    )
