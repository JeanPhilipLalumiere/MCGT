...
def render_certificate() -> str:
    ...
    lines = [
        ...
        "",
        "This certificate binds the current manuscript and delivery artifacts",
        "staged under zz-zenodo/ to the local v4.0.0 state through",
    ...
    lines.extend(
        [
            "Statement:",
            "The files listed above are the validated manuscript and delivery",
            "artifacts used for the final v4.0.0 release. Any post-validation",
