# tools/pr59_fix_guards_and_merge_v2.sh
#!/usr/bin/env bash
set -Eeuo pipefail
...
echo "[8] Auto-merge solo (abaissement TEMPORAIRE du nombre d'approbations à 0)"
...
if [[ "$STASHED" -eq 1 ]]; then
  echo "[NOTE] Des changements ont été stachés en début de script (git stash list)."
fi
