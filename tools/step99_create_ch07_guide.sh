...
# Usage :
#   bash step99_create_ch07_guide.sh /chemin/vers/MCGT
# ou, si vous êtes déjà dans ~/MCGT :
#   bash step99_create_ch07_guide.sh
#
# Par défaut, le script utilise le répertoire courant comme racine du dépôt.
...
echo "[OK] Fichier créé : docs/CH07_PIPELINE_MINIMAL_CANONIQUE.md dans $ROOT"
