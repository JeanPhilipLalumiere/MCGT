#!/usr/bin/env python3
# Script : extraire_donnees_pantheon_plus.py
...
DATA_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), "../../../zz-data/chapter8"))
...
output_file = os.path.join(DATA_DIR, "08_donnees_pantheon.csv")
...
print(f"✅ 08_donnees_pantheon.csv généré dans : {output_file}")
