...
#!/usr/bin/env python3
# fichier : zz-scripts/chapter10/generate_data_chapter10.py
...
# [autofix] disabled top-level parse: args = p.parse_args()
        ...
        description="MCGT ch10 official generator (aligned headers)"
    )
    p.add_argument(
        "--config",         required=False,
        default="zz-data/chapter10/10_mc_config.json",
