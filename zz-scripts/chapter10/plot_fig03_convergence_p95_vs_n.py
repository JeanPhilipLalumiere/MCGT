...
def main():
    ...
    p.add_argument(
        "--out", default="fig_03_convergence_p95_vs_n.png", help="PNG de sortie"
    )
    ...
    ref_median = float(np.median(p95))  # noqa: F841
    ref_tmean = trimmed_mean(p95, args.trim)  # noqa: F841
    ...
    ax.set_ylabel("estimateur de p95_20_300_recalc [rad]")
