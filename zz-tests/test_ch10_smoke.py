...
CSV = "zz-data/chapter10/10_mc_results.csv"
...
def test_ch10_csv_exists_and_has_headers():
    ...
    with open(CSV, newline="", encoding="utf-8") as f:
        ...
        expected = {"sample_id","q","m1","m2","fpeak_hz","phi_at_fpeak_rad","p95_rad"}
        assert expected.issubset(set(header)), f"headers attendus manquants: {expected - set(header)}"
