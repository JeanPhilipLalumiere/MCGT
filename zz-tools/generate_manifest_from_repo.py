#!/usr/bin/env python3
import argparse, json, os, subprocess, hashlib, sys
EXCLUDES = (".git/", ".ci-out/", "__pycache__/", ".github/", ".venv/", ".mypy_cache/", ".pytest_cache/")
...
def main():
    ...
    ap.add_argument("--roots", nargs="*", default=["zz-data","zz-figures","zz-scripts","chapters","chapter01","chapter02","chapter03","chapter04","chapter05","chapter06","chapter07","chapter08","chapter09","chapter10","tools"])
