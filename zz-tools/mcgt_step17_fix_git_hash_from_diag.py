...
def get_repo_root() -> Path:
    # Script attendu dans zz-tools/, on remonte d'un niveau
...
def extract_git_hashes_from_diag(log_path: Path) -> dict[str, str]:
    ...
    - [WARN] GIT_HASH_DIFFERS (#158:zz-figures/chapter09/09_fig_01_phase_overlay.png): git_hash diffère (manifest=5ab6..., git=64b8...)
